    ...
    private void onSetPrefCard() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (key.equals("top_level_network")
                ...
                preference.setLayoutResource(R.layout.blazeos_dashboard_preference_top);
                ...
                preference.setLayoutResource(R.layout.blazeos_dashboard_preference_middle);
                ...
                preference.setLayoutResource(R.layout.blazeos_dashboard_preference_bottom);
                gAppsExists = true;
            } else if (key.equals("top_level_accounts") && gAppsExists){
                preference.setLayoutResource(R.layout.blazeos_dashboard_preference_middle);
            } else if (key.equals("top_level_blaze")){
                preference.setLayoutResource(R.layout.blazeos_dashboard_preference_single);
            } else {
                preference.setLayoutResource(R.layout.blazeos_dashboard_preference_bottom);
            }
       }
